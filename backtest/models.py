...
class ShortStraddle(models.Model):
    ...
    max_profit_time = models.CharField()
    max_loss = models.FloatField()
    max_loass_time = models.CharField()
