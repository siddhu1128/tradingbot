...
class ShortStraddle(models.Model):
    ...
    CE_Entry_Time = models.CharField(max_length=250)
    CE_Entry_Price = models.FloatField()
    CE_Quantity = models.IntegerField()
    CE_Order_Id = models.CharField(max_length=250)
    CE_Stoploss_Order_Id = models.CharField(max_length=250)
    CE_SL_Hit = models.IntegerField(max_length=250)
    CE_TSL_Hits = models.CharField(max_length=250)
    CE_Exit_Price = models.FloatField()
    CE_Exit_Time = models.CharField(max_length=250)
    CE_pnl = models.FloatField()
    PE_Entry_Time = models.CharField(max_length=250)
    PE_Entry_Price = models.FloatField()
    PE_Quantity = models.IntegerField()
    PE_Order_Id = models.CharField(max_length=250)
    PE_Stoploss_Order_Id = models.CharField(max_length=250)
    PE_SL_Hit = models.IntegerField(max_length=250)
    ...
    max_profit_time = models.CharField(max_length=250)
    ...
    CE_Price = models.FloatField(null=True)
    PE_Price = models.FloatField(null=True)
